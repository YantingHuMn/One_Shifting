...
#SBATCH --mem=128G
#SBATCH --output=/dcs10/hongkai/data/yhu1/One_Shifting_Results/logs/submit_all_steps_vae_MLP2_%A_%a.out
#SBATCH --error=/dcs10/hongkai/data/yhu1/One_Shifting_Results/logs/submit_all_steps_vae_MLP2_%A_%a.err
...
bash ../One_Shifting/inst/scripts/run_MLP_general.sh \
    "/dcs10/hongkai/data/yhu1/One_Shifting/inst/config/config_run_multi_ATAC_HCA_10x_ENCODE.sh" \
    "$method"
