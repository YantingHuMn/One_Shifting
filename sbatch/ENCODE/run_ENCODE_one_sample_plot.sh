#!/bin/bash
#SBATCH --job-name=ENCODE_plot
#SBATCH --partition=shared
#SBATCH --time=12:00:00
#SBATCH --mem=2G
#SBATCH --output=/dcs07/hongkai/data/yhu1/One_Shifting_Results/ENCODE/AAA_logs/plot_ENCODE_%A.out
#SBATCH --error=/dcs07/hongkai/data/yhu1/One_Shifting_Results/ENCODE/AAA_logs/plot_ENCODE_%A.err
