...
run_combine_figures <- function(input_dir, way, num, col_or_row = "col") {
    ...
    # Output file paths
    pearson_output_file <- file.path(input_dir, paste0("AAA_pearson_scatter_combine_", col_or_row, ".png"))
    spearman_output_file <- file.path(input_dir, paste0("AAA_spearman_scatter_combine_", col_or_row, ".png"))
    roc_output_file <- file.path(input_dir, paste0("AAA_roc_curves_combine_", col_or_row, ".png"))
    roc_balance_output_file <- file.path(input_dir, paste0("AAA_roc_balance_curves_combine_", col_or_row, ".png"))
