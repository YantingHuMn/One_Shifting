...
run_select_tf_hvg <- function(expr_df_path, output_dir, tf_list_path = "../One_Shifting/data/DatabaseExtract_v_1.01.csv", n_hvg = 100) {
    # Load Libraries
...
run_select_tf_hvg(expr_df_path = expr_df_path, output_dir = output_dir, n_hvg = n_hvg)