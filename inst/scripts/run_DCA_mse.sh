#!/bin/bash
source ../One_Shifting/inst/config/config_run_DCA_mse.sh
...
for this_trans_factor in "${trans_factor[@]}"; do
    ...
    for factor in "${norm_factor[@]}"; do
        ...
        python -u ../One_Shifting/myproject/Step2_train_DCA_mse.py \
        ...
        python -u ../One_Shifting/myproject/Step3_reconstruct_DCA_mse.py \
        --data_path1 "$DATA_PATH1" \
        --data_path2 "$DATA_PATH2" \
