...
def _apply_norm(df, norm_factor):
    ...
    norm_factor:
        ...
        - numeric string/number, e.g. 1000:
              count / column_library_size * norm_factor
          for each column
...
def main(args):
    ...
    selected_input_path = os.path.join(save_dir, f"input_{selected_file_tag}.feather")
    selected_recon_path = os.path.join(save_dir, f"reconstruction_{selected_file_tag}.feather")
